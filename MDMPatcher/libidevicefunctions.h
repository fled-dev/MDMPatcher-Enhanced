...
int ipsw_outside_file_extract_to_memory_boot(const char *infile,
                                             unsigned char **pbuffer,
                                             size_t *psize, char *outside_path);
int extract_outside_component_boot(const char *path,
                                   unsigned char **component_data,
                                   size_t *component_size, char *outside_path);
static int read_file_into_buffer(char *path, char **buf, size_t *len);
int boot_ibec(const char *outside_path);
int boot_ibss(const char *outside_path);
int download_component(const char *url, const char *component,
                       const char *outdir);
///
